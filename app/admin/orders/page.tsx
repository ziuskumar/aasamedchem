  ...
  return (
    <div className="space-y-6">
      <div className="border-b border-zinc-800 pb-5">
        <h1 className="text-3xl font-extrabold text-white tracking-tight">Sales Orders Log</h1>
        <p className="text-sm text-zinc-400 mt-1">Review orders placed across all sellers, including full item breakdowns and conversions</p>
      </div>
      ...
      {loading ? (
        <div className="flex justify-center py-20 text-zinc-400">
          ...
          <span className="ml-3">Loading orders history...</span>
        </div>
      ) : orders.length === 0 ? (
            ...
            >
              ...
              <div className="bg-zinc-950/80 px-6 py-4 border-b border-zinc-800 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div className="grid grid-cols-2 sm:flex sm:items-center gap-x-8 gap-y-2">
                  ...
                  <div>
                    <div className="text-xs text-zinc-500 uppercase tracking-wider font-semibold">Seller</div>
                    <div className="text-sm font-semibold text-blue-400">{order.seller_name}</div>
                  </div>
                  <div>
                ...
                <div className="sm:text-right border-t sm:border-t-0 border-zinc-800 pt-3 sm:pt-0">
                  <div className="text-xs text-zinc-500 uppercase tracking-wider font-semibold">Total Order Value</div>
                ...
                <table className="w-full text-left">
                  <thead>
                    <tr className="bg-zinc-900/80 border-b border-zinc-800 text-zinc-400 text-xxs uppercase tracking-wider font-semibold">
                      ...
                      <th className="py-3 px-6 text-center">Ordered Qty</th>
                      <th className="py-3 px-6 text-center">Base Qty</th>
                      <th className="py-3 px-6 text-right">Price per Base Unit</th>
